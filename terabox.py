...
ADMINS = list(map(int, os.environ.get('ADMINS', '5928972764').split()))
if not ADMINS:
...
mongo_url = os.environ.get('MONGO_URL', 'mongodb+srv://biyeyic167:newbot@cluster0.pnggzui.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0')
...
async def start_command(client, message):
    ...
    if verify_status["is_verified"]:
        ...
        join_button = InlineKeyboardButton("Join ❤️🚀", url="https://t.me/skcreator7")
        developer_button = InlineKeyboardButton("Developer ⚡️", url="https://t.me/skcreator7")
        ...
        if IS_VERIFY:
            ...
            link = await get_shortlink(SHORTLINK_URL, SHORTLINK_API, f'https://t.me/SKrename_bot?start=verify_{token}')
            ...
            tutorial_button = InlineKeyboardButton("How to Verify", url="https://youtu.be/GuwQk8Ufu8Q")
